...
# Other imports...
from helios_client_utilities.common import __version__
import keyring
import magic
import mutagen.flac
import mutagen.id3
...
def main():
    ...
    try:
        ...
        # List of songs that were successfully downloaded now or previously that
        #  need to go in the generated CSV...
        downloaded_songs = []

        # Total number of new songs downloaded...
        new_songs_count = 0
        ...
        for index, (song_id, artist, title, album, genre, duration, filename_with_extension) in enumerate(songs):
            ...
            try:
                ...
                # Remember how many new songs were downloaded...
                new_songs_count += 1
        ...
        # Log how many songs were actually downloaded...
        logging.info(_(F"Successfully downloaded a total of {new_songs_count} new songs..."))
